        ...
        <div className="flex gap-x-4">
                                                    ...
                                                    <CommandGroup>
                                                        {roles.map((role, i) => (
                                                            <CommandItem
                                                                ...
                                                                key={role.id}
                                                                onSelect={() => {
                                                                    let selectedRoles = form.getValues().role;
                                                                    if (selectedRoles.includes(role.id)) {
                                                                        selectedRoles = selectedRoles.filter((item) => item !== role.id);
                                                                    } else {
                                                                        selectedRoles.push(role.id);
                                                                    }
                                                                    form.setValue("role", selectedRoles);
                                                                }}
                                                            >
                                                                <CheckIcon className={cn("mr-2 h-4 w-4", field.value.includes(role.id) ? "opacity-100" : "opacity-0")} />
                                                                {role.title}
                                                            </CommandItem>
                                                        ))}
                                                    </CommandGroup>
            ...
            <Card className="w-[300px] h-min sticky top-56">
                ...
                <CardContent className="space-y-2">
                    ...
                    <div className="flex flex-col space-y-1 items-center">
                        <p className="text-sm text-center font-medium leading-none">{member.role.title}</p>
