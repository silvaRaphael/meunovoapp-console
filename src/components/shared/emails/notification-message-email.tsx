...
export function NotificationMessageEmail({
    ...
    return (
        <EmailBase title={title}>
            ...
            <Text>
                Agradecemos pelo seu contínuo envolvimento e colaboração neste projeto. Estamos aqui para garantir que
                cada etapa seja transparente e alinhada aos seus objetivos.
            </Text>
            <Text>
                Se precisar de mais informações ou assistência, sinta-se à vontade para responder a este e-mail ou
                entrar em contato diretamente através da plataforma.
            </Text>
            <Text>
                Atenciosamente,
                <br />
