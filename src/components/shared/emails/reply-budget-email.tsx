...
export function ReplyBudgetEmail({
  ...
  return (
    <EmailBase title={title}>
      ...
      <Text>
        Com base na análise de suas necessidades, elaboramos uma proposta personalizada que inclui detalhes sobre o
        escopo do projeto, prazos estimados e uma estrutura de preços transparente. Estamos confiantes de que nossa
        abordagem atenderá plenamente às suas expectativas.
      </Text>
      ...
      <Text>
        ...
        Estamos disponíveis para uma reunião para discutir a proposta em detalhes, esclarecer quaisquer dúvidas e
