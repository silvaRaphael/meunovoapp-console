...
export function ResetPasswordEmail({ resetPasswordKey, name }: { resetPasswordKey: string; name: string }) {
    return (
        <EmailBase title="Recuperar sua senha">
            ...
            <Text>
                Recebemos uma solicitação para recuperação de senha associada à sua conta na MeuNovoApp. Estamos aqui
                para ajudar a restabelecer seu acesso.
            </Text>
            ...
            <Text>
                Se você enfrentar qualquer problema durante o processo ou tiver dúvidas, por favor, responda a este
                e-mail ou entre em contato conosco através de{" "}
            ...
            <Text>
                Agradecemos por escolher a MeuNovoApp. Estamos aqui para garantir que você tenha a melhor experiência
                possível.
            </Text>
            <Text>
                Atenciosamente,
